...
router.delete('/:placeId/comments/:commentId', async (req, res) => {
    ...
    if (isNaN(placeId)) {
        ...
        if (!comment) {
            ...
            res.status(403).json({
                message: `You do not have permission do delete this comment "${comment.commentId}"`
            })
